                ...
                <div className="p-5">
                  ...
                  {tab.id === "provider" && (
                    <ProviderTab
                      ...
                      agnesToken={form.agnesToken}
                      agnesStats={form.agnesStats}
                      openaiConfig={form.openaiConfig}
                      setOpenaiConfig={form.setOpenaiConfig}
                      openaiImagenConfig={form.openaiImagenConfig}
                      setOpenaiImagenConfig={form.setOpenaiImagenConfig}
                      openaiUseImagenMode={form.openaiUseImagenMode}
                      setOpenaiUseImagenMode={form.setOpenaiUseImagenMode}
                      googleConfig={form.googleConfig}
                      setGoogleConfig={form.setGoogleConfig}
                      googleImagenConfig={form.googleImagenConfig}
                      setGoogleImagenConfig={form.setGoogleImagenConfig}
                      googleUseImagenMode={form.googleUseImagenMode}
                      setGoogleUseImagenMode={form.setGoogleUseImagenMode}
                      agnesConfig={form.agnesConfig}
                      setAgnesConfig={form.setAgnesConfig}
